Shader "ShiYue/ParticleEffect/UVRollAdd" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(VertexOutput i) : COLOR {
                ...
                float4 _AmitTex_var = SAMPLE_TEXTURE2D(_AmitTex,sampler_AmitTex,TRANSFORM_TEX(node_6726, _AmitTex));
                float4 _Mask_var = SAMPLE_TEXTURE2D(_Mask,sampler_Mask,TRANSFORM_TEX(i.uv0, _Mask));
                half3 emissive = (_Brighteen*(_AmitTex_var.rgb*i.vertexColor.rgb*_Color.rgb)*(i.vertexColor.a*_Color.a*_Mask_var.r));
                half3 finalColor = emissive;
                return half4(finalColor,_AmitTex_var.a * i.vertexColor.a * _Color.a);
            }
            ENDHLSL
        }
    }
