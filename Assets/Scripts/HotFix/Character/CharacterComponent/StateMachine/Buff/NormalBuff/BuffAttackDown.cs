...
// 参数
public class BuffAttackDownParam : CharacterBuffParamT<BuffAttackDownParam>
{
	public int mIncrease;           // 降低的攻击力
	public float mPercent;          // 降低的攻击力百分比
	public override void registeAllParam()
	{
		registeParam((param) => { mIncrease = param.SToI(); });
		registeParam((param) => { mPercent = param.SToF(); });
	}
	protected override void copyInternal(BuffAttackDownParam other)
	{
...
// 攻击力降低
public class BuffAttackDown : CharacterBuffT<BuffAttackDownParam>
{
	public int mIncrease;       // 降低的攻击力
	public float mPercent;      // 降低的攻击力百分比
	public override void resetProperty()
