...
public class BuffMoveSpeedDownRougeParam : CharacterBuffParamT<BuffMoveSpeedDownRougeParam>
{
	...
	protected override void copyInternal(BuffMoveSpeedDownRougeParam other) 
	{
...
// 百分比减速,固定百分比
public class BuffMoveSpeedDownRouge : CharacterBuffT<BuffMoveSpeedDownRougeParam>
{
	protected float mSlowDown;				// 减速的绝对值
	public BuffMoveSpeedDownRouge()
	{
