...
// 子弹参数
public class BulletCustomParam_ZhenDang : ParamCopyableT<BulletCustomParam_ZhenDang>
{
	...
	//------------------------------------------------------------------------------------------------------------------------------
	protected override void initFromCopyInternal(BulletCustomParam_ZhenDang other)
	{
		mRange = other.mRange;
		mSize = other.mSize;
	}
...
// 震荡塔技能的子弹,会一直检测碰撞,碰到敌人后就销毁
public class SkillBulletZhenDang : SkillBulletT<BulletCustomParam_ZhenDang>
{
	protected Collider[] mTempResult;							// 临时对象
	protected Collider mCollider;								// 子弹碰撞体
	protected float mBaseAngle;									// 基准角度
	...
	protected bool mNotDestroyBulletOnHit;                      // 碰撞后不消失
	public SkillBulletZhenDang()
	{
	...
	public override void resetProperty()
	{
		...
		mRealtimeRange = 0.0f;
		mIndex = 0;
		mNotDestroyBulletOnHit = false;
	}
	public void setIndex(int index) { mIndex = index; }
	public void setBaseAngle(float baseAngle)  { mBaseAngle = baseAngle; }
	public float getBaseAngle() { return mBaseAngle; }
	...
	public void setNotDestroyBulletOnHit(bool value) { mNotDestroyBulletOnHit = value; }
	//------------------------------------------------------------------------------------------------------------------------------
